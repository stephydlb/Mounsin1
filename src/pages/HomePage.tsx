...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
      ...
      <h1 className="text-4xl font-bold text-green-600 mb-2">Gabon Santé Facile</h1>
      <p className="text-lg text-gray-700 mb-8 text-center max-w-md">
        Plateforme de santé centralisée pour les citoyens gabonais. Accédez à vos rendez-vous, dossiers médicaux, notifications et plus encore !
      </p>
